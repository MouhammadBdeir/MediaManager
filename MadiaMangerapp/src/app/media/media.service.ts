...
export class MediaService {
  ...
  public addCategori(mediaId : number, cat : string): Observable<FilmSerien> {
    return this.http.post<FilmSerien>(`${this.apiServerUrl}/api/categories/add/${mediaId}/${cat}`, {withCredentials: true  });
  }
  public deleteCategori(idMedia : number,idCat : number): Observable<void> {
    return this.http.post<void>(`${this.apiServerUrl}/api/categories/delete/${idMedia}/${idCat}`, { withCredentials: true });
  }
